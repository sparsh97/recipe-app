package verma.sparsh.recipeapp.bootstrap;
...
import verma.sparsh.recipeapp.domain.*;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.addIngredient(new Ingredients("Kosher salt", new BigDecimal(".5"), teapoonUom));
        ...
        tacosRecipe.addIngredient(new Ingredients("Dried Oregano", new BigDecimal(1), teapoonUom));
        tacosRecipe.addIngredient(new Ingredients("Dried Cumin", new BigDecimal(1), teapoonUom));
        tacosRecipe.addIngredient(new Ingredients("Sugar", new BigDecimal(1), teapoonUom));
        tacosRecipe.addIngredient(new Ingredients("Salt", new BigDecimal(".5"), teapoonUom));
